...
func (c *DatabaseContext) GetMemoryByTimestamp(timestamp string, logger *types.Logger) (mem.VirtualMemoryStat, error) {
...
func (c *DatabaseContext) InsertMemory(mem mem.VirtualMemoryStat, time string, logger *types.Logger) error {
...
func (c *DatabaseContext) GetCPUByTimestamp(timestamp string, logger *types.Logger) (cpu.InfoStat, error) {
	cpu := cpu.InfoStat{}
...
func (c *DatabaseContext) InsertCPU(cpu cpu.InfoStat, time string, logger *types.Logger) error {
...
func (c *DatabaseContext) GetDiskByTimestamp(timestamp string, logger *types.Logger) (disk.UsageStat, error) {
	disk := disk.UsageStat{}
...
func (c *DatabaseContext) InsertDisk(disk disk.UsageStat, time string, logger *types.Logger) error {
